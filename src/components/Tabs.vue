<template>
  <nav class="tabs">
    ...
    <div class="bookmark-bar-border sticky-top" :style="`background: linear-gradient(90deg, var(--accentColor), var(--accentColor) ${activeTabIndex * 100 - 100}px, transparent ${activeTabIndex * 105 + 400}px);`">
